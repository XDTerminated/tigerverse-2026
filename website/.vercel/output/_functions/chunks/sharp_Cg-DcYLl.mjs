import { A as AstroError, q as MissingSharp } from './entrypoint_D78FRL_G.mjs';
import { b as baseService, p as parseQuality } from './generic_733Vv8Ig.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BKtIozJl.mjs').then(n => n.i)).default;
  } catch {
